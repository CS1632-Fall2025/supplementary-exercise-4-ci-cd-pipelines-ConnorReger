...
public class RentACatIntegrationTest {
	...
	public void testGetCatNullNumCats0() {
		...
		try {
            ...
            Cat rc = (Cat) m.invoke(r, 2);
            assertNull(rc);
            assertEquals("Invalid cat ID." + newline, out.toString());
        } catch (Exception e) {
            fail("Reflection call to getCat failed: " + e);
        }
	}
	...
	public void testRenameFailureNumCats0() {
		// TODO: Fill in
		boolean ok = r.renameCat(2, "Garfield");
        assertFalse(ok);
        assertEquals("Invalid cat ID." + newline, out.toString());
	}
	...
	public void testRentCatFailureNumCats3() {
		// TODO: Fill in
		r.addCat(c1); r.addCat(c2); r.addCat(c3);
        assertTrue(r.rentCat(2));       // initial rent
        out.reset();                    // clear output before the assertion
        boolean ok = r.rentCat(2);      // second attempt
        assertFalse(ok);
        assertTrue(c2.getRented());
